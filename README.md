...
Ứng dụng dịch nhanh cho macOS.
Có thể dịch nhanh chóng ở mọi ứng dụng khác bằng các hiện Popup ngay tại ứng dụng đó.
Dịch văn bản nhanh chóng và chính xác bằng OpenAI API.
Có thể lựa chọn:
- dịch nghĩa (đọc tài liệu)
- dịch ngữ pháp (dành cho việc học và hiểu).
